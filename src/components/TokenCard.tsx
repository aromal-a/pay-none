  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mt-2 w-full flex items-center justify-center gap-2 rounded-xl border-2 border-border bg-card py-2.5 text-sm font-semibold text-foreground transition-all hover:border-blue-400 hover:bg-blue-50 active:scale-[0.98]"
      >
